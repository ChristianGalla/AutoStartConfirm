...
namespace AutoStartConfirm.Connectors.Registry
{
    public class CurrentUserTerminalServerRunConnector : RegistryConnector, ICurrentUserTerminalServerRunConnector
    {
        ...
        public const string basePath = @"HKEY_CURRENT_USER\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Terminal Server\Install\Software\Microsoft\Windows\CurrentVersion\Run";
