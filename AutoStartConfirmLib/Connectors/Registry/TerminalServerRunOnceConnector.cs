...
namespace AutoStartConfirm.Connectors.Registry
{
    public class TerminalServerRunOnceConnector : RegistryConnector, ITerminalServerRunOnceConnector
    {
        ...
        public const string basePath = @"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Terminal Server\Install\Software\Microsoft\Windows\CurrentVersion\Runonce";
